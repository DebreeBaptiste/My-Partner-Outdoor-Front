...
function ForgetPassword() {
  return (
    ...
    <form className='forgetpassword__form'>
      ...
      <button className='forgetpassword__form__button__submit' type="submit">Annuler</button>
      <button className='forgetpassword__form__button__cancel' type="submit">Envoyer</button>
      </div>
    </form>
  </div>
  );
