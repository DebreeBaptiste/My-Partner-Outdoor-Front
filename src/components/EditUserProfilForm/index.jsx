...
import userBirthday from '../../assets/icon-calendar.svg';
import userLocation from '../../assets/icon-location-pin.svg';
import userEmail from '../../assets/icon-at.svg';
import userAddressTrash from '../../assets/icon-trash.svg';
