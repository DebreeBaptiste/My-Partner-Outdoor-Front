...
export const initialState = {
  messages: [
    { message: 'RDV à 11 h petante, pas de retard svp', user: 'Axel', picture: "photo" },
    { message: 'J’ai oublier mon ballon de foot, tu en as un toi ', user: 'John', picture: "photo" },
    { message: 'J’ai oublier mon ballon de foot, tu en as un toi ', user: 'Olivier', picture: "photo" },
    { message: 'Ah non c’est bon enfaite, pas de probleme', user: 'Olivier', picture: "photo" },
